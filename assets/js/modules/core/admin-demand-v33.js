// =============================================================
// LUTMIN V33.0 · ADMIN SECONDARY DATA DEMAND CACHE
...
(function(){
  ...
  // V33: el admin-module-loader coordina HTML + runtime + datos secundarios.
  // No se envuelve setAdminModuleV19 para evitar disparos duplicados.
  function installWrapper(){return true;}
