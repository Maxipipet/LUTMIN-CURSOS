// LUTMIN V32.0 · enlaces del core para vistas HTML cargadas bajo demanda.
(function(){
  'use strict';
  function bind(view){
  ...
  window.LutminV32CoreBindings={bind};
  window.LutminV31CoreBindings=window.LutminV32CoreBindings;
})();
